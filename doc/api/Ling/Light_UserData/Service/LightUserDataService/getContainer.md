...
Source Code
===========
See the source code for method [LightUserDataService::getContainer](https://github.com/lingtalfi/Light_UserData/blob/master/Service/LightUserDataService.php#L795-L798)
