...
DirectoryMapApi::deleteDirectoryMapByObfuscatedName
================



DirectoryMapApi::deleteDirectoryMapByObfuscatedName — Deletes the directoryMap identified by the given obfuscated_name.
...
Source Code
===========
See the source code for method [DirectoryMapApi::deleteDirectoryMapByObfuscatedName](https://github.com/lingtalfi/Light_UserData/blob/master/Api/DirectoryMapApi.php#L108-L114)
...
Previous method: [updateDirectoryMapByObfuscatedName](https://github.com/lingtalfi/Light_UserData/blob/master/doc/api/Ling/Light_UserData/Api/DirectoryMapApi/updateDirectoryMapByObfuscatedName.md)<br>Next method: [setPdoWrapper](https://github.com/lingtalfi/Light_UserData/blob/master/doc/api/Ling/Light_UserData/Api/DirectoryMapApi/setPdoWrapper.md)<br>
