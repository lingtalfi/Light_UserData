...
DirectoryMapApi::doUpdateDirectoryMapByObfuscatedName
================



DirectoryMapApi::doUpdateDirectoryMapByObfuscatedName — The working horse behind the updateDirectoryMapByObfuscatedName method.
...
Source Code
===========
See the source code for method [DirectoryMapApi::doUpdateDirectoryMapByObfuscatedName](https://github.com/lingtalfi/Light_UserData/blob/master/Api/DirectoryMapApi.php#L209-L215)
...
Previous method: [doGetDirectoryMapByObfuscatedName](https://github.com/lingtalfi/Light_UserData/blob/master/doc/api/Ling/Light_UserData/Api/DirectoryMapApi/doGetDirectoryMapByObfuscatedName.md)<br>Next method: [doDeleteDirectoryMapByObfuscatedName](https://github.com/lingtalfi/Light_UserData/blob/master/doc/api/Ling/Light_UserData/Api/DirectoryMapApi/doDeleteDirectoryMapByObfuscatedName.md)<br>
