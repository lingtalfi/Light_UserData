...
DirectoryMapApi::doInsertDirectoryMap
================



DirectoryMapApi::doInsertDirectoryMap — The working horse behind the insertDirectoryMap method.
...
Source Code
===========
See the source code for method [DirectoryMapApi::doInsertDirectoryMap](https://github.com/lingtalfi/Light_UserData/blob/master/Api/DirectoryMapApi.php#L132-L169)
