...
DirectoryMapApi::setContainer
================



DirectoryMapApi::setContainer — Sets the container.
...
Source Code
===========
See the source code for method [DirectoryMapApi::setContainer](https://github.com/lingtalfi/Light_UserData/blob/master/Api/DirectoryMapApi.php#L113-L116)
