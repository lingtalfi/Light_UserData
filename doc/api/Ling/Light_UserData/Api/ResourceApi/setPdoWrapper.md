...
ResourceApi::setPdoWrapper
================



ResourceApi::setPdoWrapper — Sets the pdoWrapper.
...
Source Code
===========
See the source code for method [ResourceApi::setPdoWrapper](https://github.com/lingtalfi/Light_UserData/blob/master/Api/ResourceApi.php#L129-L132)
...
Previous method: [deleteResourceById](https://github.com/lingtalfi/Light_UserData/blob/master/doc/api/Ling/Light_UserData/Api/ResourceApi/deleteResourceById.md)<br>
