...
Source Code
===========
See the source code for method [LightUserDataService::installDatabase](https://github.com/lingtalfi/Light_UserData/blob/master/Service/LightUserDataService.php#L126-L196)
